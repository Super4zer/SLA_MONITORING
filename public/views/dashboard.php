...
<head>
    ...
    body {
        ...
        /* Abu-abu terang sesuai referensi */
        color: #1e1e2d;
        overflow: hidden;
        height: 100vh;
    }
    ...
    .nav-sidebar .nav-link.active {
        ...
        /* Kuning/Hijau stabilo ala referensi */
    ...
    .topbar {
        ...
        /* Topbar menyatu dengan background */
        display: flex;
        align-items: center;
    ...
    .ticket-card.waiting { border-left-color: #f59e0b; }
    .ticket-card.overdue { border-left-color: #f43f5e; }
    .ticket-card.completed { border-left-color: #10b981; }
    ...
    .duration-waiting { color: #f59e0b; }
    .duration-overdue { color: #f43f5e; }
    .duration-completed { color: #10b981; }
    ...
    .btn-resolve:hover { background: #bceb00; }
