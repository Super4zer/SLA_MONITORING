...
<head>
    ...
    .login-container {
        ...
        width: 100%;
        max-width: 1050px;
        /* Sedikit dilebarkan agar proporsi gambar optimal */
        display: flex;
        min-height: 620px;
        /* Ditinggikan agar gambar vertikal lebih terlihat */
    }
    ...
    .login-branding {
        ...
        width: 40%;
        padding: 40px;
        /* Jarak presisi dari pojok container */
        display: flex;
        flex-direction: column;
        justify-content: flex-start;
        gap: 32px;
        /* Jarak seragam antara logo, gambar, dan teks */
        position: relative;
        overflow: hidden;
    }
    ...
    .login-branding::before {
        ...
        right: 0;
        bottom: 0;
        background-image: radial-gradient(rgba(204, 255, 0, 0.08) 1px,
                transparent 1px);
    ...
    .brand-logo {
        ...
        /* Memastikan logo mentok ke kiri */
        z-index: 1;
    }
    ...
    .dummy-photo-wrapper {
        flex-grow: 1;
        /* Membuat container otomatis memanjang secara vertikal */
        width: 100%;
        min-height: 200px;
        border-radius: 16px;
        overflow: hidden;
    ...
    .dummy-photo-wrapper img {
        ...
        height: 100%;
        object-fit: cover;
        /* Gambar tidak akan gepeng, otomatis terpotong proporsional */
        display: block;
    }
