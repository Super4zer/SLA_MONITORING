  ...
  <head>
    ...
    <style>
      body {
        ...
        background-color: #f2f3f7; /* Abu-abu terang sesuai referensi */
        color: #1e1e2d;
        overflow: hidden;
        height: 100vh;
      }
      ...
      .sidebar {
        width: 250px;
        background-color: #1c1c24; /* Hitam gelap ala referensi */
        display: flex;
      ...
      .nav-sidebar .nav-link {
        ...
        gap: 14px;
        font-size: 14px;
        border-left: 3px solid transparent; /* Persiapan untuk active state */
      ...
      .nav-sidebar .nav-link.active {
        color: #ffffff;
        border-left: 3px solid #ccff00; /* Kuning/Hijau stabilo ala referensi */
      ...
      .topbar {
        height: 80px;
        background-color: transparent; /* Topbar menyatu dengan background */
        display: flex;
        align-items: center;
      ...
      .dashboard-card {
        ...
        border: none;
        border-radius: 16px;
        box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.03); /* Bayangan sangat halus */
        padding: 24px;
        height: 100%;
        display: flex;
        flex-direction: column;
      ...
      .list-container-scroll::-webkit-scrollbar-track {
        background: transparent;
      }
      .list-container-scroll::-webkit-scrollbar-thumb {
        background: #e2e2e8;
        border-radius: 10px;
      }
      ...
      /* Dots Indicator Pengganti Border Tebal */
      .dot-indicator {
    ...
    <div class="d-flex h-100 w-100">
      <aside class="sidebar d-none d-lg-flex">
        <div class="sidebar-brand">
          <span
            class="fw-bold text-white fs-4 d-flex justify-content-center align-items-center"
          >
            <img
              src="images/DSI.png"
              alt=""
        ...
        <div class="sidebar-footer">
          ...
          <a href="#" class="ms-auto text-secondary"
            ><span class="material-symbols-outlined fs-5">logout</span></a
          >
        </div>
      </aside>
        ...
        <main class="main-content">
          <div class="row g-4 mb-4">
            <div class="col-lg-3 col-md-6">
              <div
                class="dashboard-card align-items-center justify-content-center p-3"
              >
            ...
            <div class="col-lg-3 col-md-6">
              <div class="dashboard-card justify-content-center">
                <div class="stat-header">
                  ...
                  <div
                    class="stat-icon-small bg-warning bg-opacity-10 text-waiting"
                  >
            ...
            <div class="col-lg-3 col-md-6">
              <div class="dashboard-card justify-content-center">
                <div class="stat-header">
                  ...
                  <div
                    class="stat-icon-small bg-danger bg-opacity-10 text-overdue"
                  >
            ...
            <div class="col-lg-3 col-md-6">
              <div class="dashboard-card justify-content-center">
                <div class="stat-header">
                  ...
                  <div
                    class="stat-icon-small bg-success bg-opacity-10 text-completed"
                  >
                    <span class="material-symbols-outlined fs-6"
                      >check_circle</span
                    >
            ...
            <div class="col-lg-4">
              <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class="fw-bold text-waiting small" id="count-waiting"
                    >0</span
                  >
                </div>
                ...
                <div class="list-container-scroll">
                  <table class="table table-hover text-nowrap">
                    ...
                    >
                      <tr>
                        <th class="ps-1 border-0">Klien</th>
                        <th class="border-0">Pesan</th>
                        <th class="text-end pe-1 border-0">Durasi</th>
                      </tr>
                    </thead>
            ...
            <div class="col-lg-4">
              <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class="fw-bold text-overdue small" id="count-overdue"
                    >0</span
                  >
                </div>
            ...
            <div class="col-lg-4">
              <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span
                    class="fw-bold text-completed small"
                    id="count-completed"
                    >0</span
                  >
                </div>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    >
                      <tr>
                        <th class="ps-1 border-0">Klien</th>
                        <th class="border-0">Pesan</th>
                        <th class="text-end pe-1 border-0">Waktu</th>
                      </tr>
                    </thead>
                    <tbody id="list-completed">
                      <tr>
                        <td
                          colspan="3"
                          class="text-center text-muted py-5"
